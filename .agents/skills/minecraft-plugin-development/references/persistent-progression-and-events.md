...
- Keep dependencies in the project's active descriptor aligned with startup code: Bukkit-style `depend`/`softdepend` or native Paper's dependency/classpath model as applicable.
