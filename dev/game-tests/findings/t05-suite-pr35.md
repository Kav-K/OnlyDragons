# T05 historical PR35 suite evidence
...
> Acceptance correction (6 September): the old console ERROR matcher missed
> Yggdrasil public-key and PaperVersionFetcher ERROR lines in this receipt.
> Recorded assertions and source identities are historical observations; the
> old automated-ready result cannot establish acceptance. PR44 corrects the
> matcher. A fresh combined current-input suite and task checkpoint are pending.
