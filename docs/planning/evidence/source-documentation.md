...
| Explicit API-tag polish | 614 formal tags in 210 existing comments across 59 domain/application files; independently reviewed | `4c63f793c7cbfb151440667e384b1936157eacf7` |
...
rewriting. Explicit domain/application API parameter/return tags are complete;
the polish adds no constructors, signatures or executable changes.
...
suppress doclint or change repository configuration. The combined build and
generation at `4a56319238af0a98f1ca21519b1e7d2fdeed914a` pass with no
compilation/Javadoc errors. Missing formal tags or
...
Current final-head CI, independent review and exact combined acceptance are
recorded on [PR98](https://github.com/Kav-K/OnlyDragons/pull/98). Treat this
maintenance as accepted only when that PR is merged after those gates pass;
the documentation inventory alone does not establish acceptance.
