...
| T06 — Firing/Duplex | In review; full-cohort gate pending | [#9](https://github.com/Kav-K/OnlyDragons/issues/9), [draft PR #52](https://github.com/Kav-K/OnlyDragons/pull/52) | Owned firing/session/settlement and two-player fixtures implemented. Clean `49fa9ae` includes main `92147a2` and passes 115 actual-Paper assertions plus 182 production/28 client tests. [API, exact evidence and scoped lifecycle findings](evidence/t06-firing.md). Complete 24-case hosted cohort/T06 checkpoint, final review and CI remain pending; human feel/visual/authenticated-client observations remain unrun. |
