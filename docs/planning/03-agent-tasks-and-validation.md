...
| --- | --- | --- | --- |
| 2026-09-05 | T04 / #5 continuation | Measured player-owned native-positive/suppression controls, part geometry and same-tick damage-event loss; retained uniform scaling and explicit terminal-arrow retirement for review. No production adapter or client protocol change. | Clean 7b3a172: 52 Paper assertions, expected early-exit failure with clean paired cleanup; 74 production/2 client/37 runner tests. [Evidence and unresolved long-sequence actor failure](../../dev/game-tests/findings/projectile-player-feasibility.md). #9/M0 remain gated. |
