...
T08's connected dummy combat and explanations retain their five accepted requirements;
[T08 evidence](evidence/t08-suite.md).
T07 retains P07/P10 [acceptance](evidence/t07-suite.md); T06, T09e, T02b/T05
and bounded M0 retain their prior evidence. T08a is accepted through [PR #60](https://github.com/Kav-K/OnlyDragons/pull/60) at `889a3db`; [full evidence](evidence/t08a-suite.md). T08b's [focused archive](evidence/t08b-focused-paper.md) preserves worker runs and earlier iterations. T08c remains planned and undispatched pending the first human checkpoint and lead assignment; M1–M5 remain unaccepted.
Windows Build, two same-profile smoke boots and normal Play startup passed on
merged `1149169`; [separate operator evidence](evidence/t08b-suite.md#separate-windows-operator-checkpoint).
Authenticated connection, full-client appearance, aiming and chat readability remain unrun.
...
PR #32 completes T09c and objective connected-player T01b acceptance. The playable managed dummy, direct test-dragon fight and frozen leaderboard are integrated; countdown/prefire, ritual and rewards remain later work. The recorded T00
...
explicit T09b player fixture and maintenance mappings. Symphony is configured
for up to three parallel coding workers and draft PR handoff; the lead may merge
...
| T08b — Frozen damage ranking | Complete | [#40](https://github.com/Kav-K/OnlyDragons/issues/40), [PR #62](https://github.com/Kav-K/OnlyDragons/pull/62) | Merged at `1149169` after tested `e172456` passed all 33 hosted outcomes, independent raw/source review, strict replay, actual-main checkpoint and current-head CI. Exactly `frozen-damage-ranking` accepted; [full evidence](evidence/t08b-suite.md). Human readability/authentication/appearance/aiming and M1–M5 remain separate. |
| T08c — Personal loot simulation | Planned, not dispatched | [#41](https://github.com/Kav-K/OnlyDragons/issues/41) | T02b/T08b integrated; awaits the first human checkpoint and lead assignment. Personal placement-dependent previews with hard item locks and explicit sample calibration. Real rewards always disabled; all resolver/no-grant Paper evidence pending. |
...
Bounded M0 contracts/feasibility is explicitly accepted; M1–M5 remain unaccepted. T02b/T05/T06/T07/T08 are integrated. P02/P04 are accepted under T06, P07/P10 under T07, P01/P13 under T08 and P08/P09 under T05b; P03/P05/P06/P11/P12/P14 stay pending. Shared fixtures do not accept future gameplay behavior. A task's
...
**Complete through [PR #73](https://github.com/Kav-K/OnlyDragons/pull/73), merged
at `29f0cf3969e7d256b2f678a54f846d836ca6db9f`.** Exactly
`fatal-tempo-ghost-scaling`, P08 and P09 are accepted. The scoped
[v2 contract](02-foundation-plan.md#t05b-level-based-ghost-policy-gh-66) preserves
parent-bound HP provenance and explicit standard/training/calibration selections.

Clean runtime `b63948c`, including actual base `7a38040`, passed all 34 hosted
outcomes (25 positive, nine intended controls), 251 production / six companion /
28 client tests, independent raw/source review, strict original and documentation-
head replay, the T05b checkpoint and current CI. The 31-assertion `tempo-ghost`
case proves actual Duplex/Ferocity counts, captured FT bow-swap policy, original
expiry and frozen training overkill credit; [exact acceptance evidence](evidence/t05b-suite.md).
...
T06c/#70 is complete through [PR #81](https://github.com/Kav-K/OnlyDragons/pull/81), merged at `53164f85a0ba3f36d16f242429f3a0a7c5a403a7`, accepting exactly `quiver-flame-integration`; [accepted evidence](evidence/t06c-focused-paper.md#accepted-hosted-cohort). MAINT-82 is accepted and merged through [PR #83](https://github.com/Kav-K/OnlyDragons/pull/83) at `2158a51572d65e7e8856ec77f44b3decc982450c`; T06b/#68 and T02c/#69 were subsequently accepted through [PR #86](https://github.com/Kav-K/OnlyDragons/pull/86); [combined acceptance evidence](evidence/checkpoint2-held-books.md). Human appearance,
...
T06b/T02c are subsequently accepted consumers through PR #86; [combined acceptance evidence](evidence/checkpoint2-held-books.md).
...
The unchanged [ammo/fire contract](02-foundation-plan.md#t06c-ammunition-and-owned-fire-contract-gh-70)
and [focused/failed evidence archive](evidence/t06c-focused-paper.md) retain their
original identities. The fresh 42-case/48-boot cohort, strict replay, independent
...
MAINT-82 is accepted and merged through [PR #83](https://github.com/Kav-K/OnlyDragons/pull/83) at `2158a51572d65e7e8856ec77f44b3decc982450c`; T06b/#68 and T02c/#69 were subsequently accepted through [PR #86](https://github.com/Kav-K/OnlyDragons/pull/86); [combined acceptance evidence](evidence/checkpoint2-held-books.md).

### T02c — Custom enchant books and XP-cost anvils (GH-69)

**Complete through [PR #86](https://github.com/Kav-K/OnlyDragons/pull/86) at `1a63ce5749e4debe4369cd154953ffea3e07e09a`, exactly `enchant-books-anvil`.** [combined acceptance evidence](evidence/checkpoint2-held-books.md).
The original [PR #85](https://github.com/Kav-K/OnlyDragons/pull/85) worker branch
`symphony/gh-69` retains clean focused runtime `4ed3d2de175d4fde921370630bf5c392efcd08a3`
...
The final combined cohort/receipt, new-tier interaction, T02c checkpoint,
current CI and independent source/raw review passed; [combined acceptance evidence](evidence/checkpoint2-held-books.md).
This scoped acceptance does not accept a milestone. Authenticated clients,
...
**Complete through [PR #86](https://github.com/Kav-K/OnlyDragons/pull/86) at `1a63ce5749e4debe4369cd154953ffea3e07e09a`, exactly `held-shortbow-loadouts`.**
The original [PR #84](https://github.com/Kav-K/OnlyDragons/pull/84), [GH-68](https://github.com/Kav-K/OnlyDragons/issues/68),
`symphony/gh-68` worker history starts from accepted main2158a515. Additive seven named v4 presets,
...
T03b/T08e/T06c are integrated. PR86 combines GH69 shared lore/book/anvil/client edits
and verifies new-tier→real-anvil opening with native view and received ANVIL
packets, complete regression, current CI and acceptance. Historical worker
...
PR #62 merged at `1149169` on 2026-09-06 after the complete 33-case `e172456`
cohort, independent raw/source review, strict replay, actual-main checkpoint and
current-head CI. [Full T08b evidence](evidence/t08b-suite.md) completes exactly
`frozen-damage-ranking`; the focused archive retains original iterations.
No other requirement or milestone advances. T08c remains planned and undispatched
pending the first human checkpoint and lead assignment; real rewards stay disabled.

PR #60 merged at `889a3db` on 2026-09-06; [full T08a evidence](evidence/t08a-suite.md) completes exactly `managed-dragon-development`. At that handoff, T08b was lead-assigned and awaiting its label. Other completed requirements and all milestone states were unchanged.
...
original/latest-main checkpoints plus current CI. [Accepted evidence](evidence/t08-suite.md).
T08 completes exactly P01, P13, `headless-player-primitives`,
`headless-damage-primitives` and `automated-multiplayer-attribution`. T08a is
lead-assigned and awaiting its dispatch label; no other task or milestone completes.
...
[Consumer contract and earlier iterations](evidence/t07-tracer.md). At that acceptance,
T08 remained active; no milestone or other task was advanced.
...
combined task checkpoints, and current CI. Its six requirements include
...
cohort. [Exact evidence and boundaries](evidence/t09e-suite.md). At that merge,
T06 remained active; managed-dragon recovery and M1–M5 remained unaccepted.
...
remain scoped to their earlier inputs. At PR #31 acceptance, T06 was planned
and eligible for the lead's label; P02/P04 and actual multiplayer firing were
its deferred production work. That PR accepted no milestone.
...
| 2026-09-06 | Encounter task registration: T02b/T08a/T08b/T08c | Register one test dragon, shared managed controls, frozen credited-damage ranking and personal rank-based loot simulation. Ghost credit includes reduced/zero-HP procs and lethal overkill, never post-death hits; the lead records the unique-placement tie rule in [the encounter scope](05-encounter-expansion.md). | Registration-time snapshot: issues #38–#41 had five deferred automated requirements with no fixture bindings or completed progress. T10 additionally consumes T08a; every previous dependency and M3/T11/T12 gate is retained. Registration is not dispatch, implementation or acceptance; real rewards remain disabled. |
...
**Accepted through PR #48 at `3c35a85`.** The combined `e38334e` cohort passed all 21 declared outcomes, including 38 required proc assertions plus shared cleanup; 163 production and 28 client tests had zero failures/errors/skips. Independent replay/review, supported task checkpoints and current CI passed. [Combined evidence and hashes](evidence/catalog-procs-suite.md). T08 composition and physical P08/P09 were later integration at that acceptance; they are now separately accepted under T08 and [T05b](evidence/t05b-suite.md).
...
P02/P04 were outside T04's feasibility acceptance and are now separately
accepted under T06 through [PR #52 evidence](evidence/t06-suite.md). Bounded M0
was subsequently accepted through the [PR48 cohort and separate policy review](evidence/catalog-procs-suite.md); M1–M5 remain unaccepted.
...
**Accepted through PR #52 at `25891c0`.** [The final 24-case cohort](evidence/t06-suite.md)
and independent current-input review/checkpoint/CI establish exactly
`firing-input`, P02, P04, `headless-player-primitives`,
`headless-damage-primitives` and `automated-multiplayer-firing`. T08 consumes
the [settled-hit contract](evidence/t06-firing.md#consumer-contract) to connect
combat/procs once; P01/P13 and multiplayer attribution were subsequently accepted under T08, with P08/P09 separately accepted under [T05b](evidence/t05b-suite.md).
...
**Accepted through PR #57 at `3505d6c`.** The complete 28-case hosted cohort
and independent acceptance establish the five T08 requirements; [final evidence](evidence/t08-suite.md).
The shared backend/receiver, bounded observer/cleanup behavior and atomic frozen
provenance are available to #39/#40. The [peer integration archive](evidence/t08-peer-integration.md)
and [original focused archive](evidence/t08-focused.md) retain their exact
source/artifact/run identities and earlier limitations. Windows Build/Play,
authentication, visuals and performance remain unrun for this T08 acceptance.
...
T08b/#40 is accepted through PR #62 at `1149169`; [full evidence](evidence/t08b-suite.md), with worker iterations preserved in the [focused archive](evidence/t08b-focused-paper.md).
Reuse mature fixtures and add only necessary feature cases. Windows Build/Play and human observations were unrun at T08a acceptance; later [operator build, smoke and Play readiness](evidence/t08b-suite.md#separate-windows-operator-checkpoint) are separate evidence. Authentication, readability/aiming/visuals and performance remain unaccepted.
...
`frozen-damage-ranking` is accepted with the `dragon-ranking` fixture and deterministic tie/transitivity/boundary tests; [full cohort and review](evidence/t08b-suite.md). Reconnects, map order, later gear and late hits must not reorder a frozen result; retries announce once. The immutable placement/result identity is available to T08c. Persistent global rankings are outside this task.
...
GH-40 implementation uses the same immutable completion and existing read-only
subscription on every production spawn. Pure tests cover precision, all input
...
[Focused clean-source Paper evidence](evidence/t08b-focused-paper.md) passes at
`bdde815`: 24 ranking/49 dragon-combat assertions, exact once-only received
sequences, and 231 production/6 companion/28 client tests. The later complete
33-case hosted cohort, independent raw/source review, strict replay, actual-main
checkpoint and current CI passed; [accepted evidence](evidence/t08b-suite.md).
...
T06c, T02c and T06b are integrated consumers of the formatter boundary in document 02
...
views; T06b now consumes this integrated backend/profile; T10 retains its remaining
