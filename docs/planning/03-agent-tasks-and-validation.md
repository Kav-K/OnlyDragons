...
| T06 — Firing/Duplex | In review; failed full cohort under lead review | [#9](https://github.com/Kav-K/OnlyDragons/issues/9), [draft PR #52](https://github.com/Kav-K/OnlyDragons/pull/52) | Clean `49fa9ae` passes 115 actual-Paper assertions plus 182 production/28 client tests. Combined `92d4a37` includes main `92147a2` and reviewed Git-test cleanup; 257 Python tests and current CI pass. Hosted full cohort `34035343529` failed its Paper job; the lead owns artifact diagnosis, remediation and the remaining receipt/T06 checkpoint. [Exact evidence and handoff](evidence/t06-firing.md). No T06 acceptance; human observations remain unrun. |
