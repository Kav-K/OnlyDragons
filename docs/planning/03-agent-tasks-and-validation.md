...
| T02b — Test dragon definitions | In review | [#38](https://github.com/Kav-K/OnlyDragons/issues/38) | Prerequisites integrated; one immutable 1,000-HP test definition, strict atomic production loader/registry and inert T02 item bindings implemented on `symphony/gh-38`. JDK 25 wrapper build passed 107 production tests (zero failures/errors/skips); 29-assertion production-loader scenario and full 18-case selected suite await actual Paper evidence. No spawn engine or real rewards. |
