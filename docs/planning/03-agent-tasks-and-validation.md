...
Baseline reconciled **6 September 2026** after PR #57 merged at
...
PR #32 completes T09c and objective connected-player T01b acceptance. The playable managed dummy is integrated; full dragon encounters remain later work. The recorded T00
...
| T08b — Frozen damage ranking | In review | [#40](https://github.com/Kav-K/OnlyDragons/issues/40), [draft PR #62](https://github.com/Kav-K/OnlyDragons/pull/62) | Clean `bdde815` passed 231 production/6 companion/28 client tests, 24 ranking and 49 dragon-combat Paper assertions; [focused evidence](evidence/t08b-focused-paper.md). Full hosted regression, independent replay/CI and acceptance remain lead-owned; human readability/authentication unrun. |
...
T08b/#40 is dispatched on `symphony/gh-40`; frozen projection/presentation is In review with [focused evidence](evidence/t08b-focused-paper.md); lead acceptance remains pending.
...
sequences, and 231 production/6 companion/28 client tests. The lead's dispatch assigns the
