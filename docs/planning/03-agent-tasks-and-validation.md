...
| T06 — Firing/Duplex | In progress | [#9](https://github.com/Kav-K/OnlyDragons/issues/9) | Owner dispatched at main `3c35a85`; production registry/input/settlement implementation and two-player fixtures are in progress. [API, calibration, native ammo discovery and current validation](evidence/t06-firing.md). No feature acceptance yet; P02/P04, simultaneous ownership and the complete T06 cohort remain required. |
