...
| T09 — Gameplay validation | In progress (T09a integrated; T09b underway) | [#2](https://github.com/Kav-K/OnlyDragons/issues/2), [PR #16](https://github.com/Kav-K/OnlyDragons/pull/16), [#20](https://github.com/Kav-K/OnlyDragons/issues/20) | Environment controls passed and merged; see [positive/negative calibration](../../dev/agent-paper-tests.md#accepted-calibration-evidence). T09b adds a pinned protocol-player calibration with an explicit disposable offline mode; real login/input and failure controls remain pending until recorded. Feature scenarios and authenticated human/client gates remain as features land. |
