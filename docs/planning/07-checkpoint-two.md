...
**Checkpoint 2 — the original seven scoped tasks retain automated acceptance. T07b is dispatched and in progress; T06d is deferred by the user. Human milestone outcomes remain separate.**
...
the first lead-selected calibration. T07b is the single dispatched small chunk;
