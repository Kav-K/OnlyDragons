...
The later PR81 hosted cohort and lead acceptance at main `53164f85a0ba3f36d16f242429f3a0a7c5a403a7`
are recorded [separately](evidence/t06c-focused-paper.md#accepted-hosted-cohort);
these historical inputs do not validate changed MAINT-82 source.
...
This inspection is API/source evidence, not an upstream game-balance claim;
separate final transaction acceptance is recorded in the [combined acceptance evidence](evidence/checkpoint2-held-books.md). [T02c status](03-agent-tasks-and-validation.md#t02c--custom-enchant-books-and-xp-cost-anvils-gh-69).
